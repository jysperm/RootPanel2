...
<div id="page">
    ...
    <table width="100%" cellpadding="3" cellspacing="0">
        ...
        <tr>
            <td>操作系统: <?php $os = explode(" ", php_uname());
                echo $os[0]; ?></td>
        </tr>
        <tr>
                ...
                if ($info[2][0] > 0) {
                    ...
                    <tr>
                        <td>网络-<?php echo $info[1][0] ?>
                            <br/>已接收: <?php $tmp = round($info[2][0] / 1024 / 1024, 3);
                            $tmp2 = round($tmp / 1024, 3);
                            echo $tmp2; ?> G
                            <br/>已发送: <?php $tmp = round($info[10][0] / 1024 / 1024, 3);
                            $tmp2 = round($tmp / 1024, 3);
                            echo $tmp2; ?> G
                        </td>
                    </tr>
    ...
    <div id="footer">
        &copy; <?php echo date("Y", time()); ?> <A HREF="http://www.Yahei.Net"
                                                   target="_blank"><?php echo $title . $version; ?></A>
    </div>
