...
<form class="website-form">
    <div class="form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <textarea id="pptppasswd" name="pptppasswd"
                              rows="6"><?= $user["settings"]["pptppasswd"]; ?></textarea>
                </label>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <textarea id="nginxextconfig" name="nginxextconfig"
                              rows="6"><?= $user["settings"]["nginxextconfig"]; ?></textarea>
                </label>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <textarea id="apache2extconfig" name="apache2extconfig"
                              rows="6"><?= $user["settings"]["apache2extconfig"]; ?></textarea>
                </label>
            </div>
        </div>
    </div>
