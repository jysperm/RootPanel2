...
<section>
    ...
    <header><?= l("logs.detailLog");?> <span class="text-small-per50 not-bold"><?= l("logs.pageInfo", $page, $rows);?></span></header>
    <table class="table table-striped table-bordered table-condensed">
        <thead>
        <tr>
            <th style="min-width: 50px;"><a href="#" rel="tooltip" title="<?= l("logs.tooltip.logid"); ?>"><?= l("logs.id");?></a>
            </th>
            <th style="min-width: 90px;"><a href="#" rel="tooltip" title="<?= l("logs.tooltip.by"); ?>"><?= $ifSelect ? "": l("logs.user"); ?><?= l("logs.actionBy");?></a></th>
            <th style="min-width: 90px;"><a href="#" rel="tooltip" title="<?= l("logs.tooltip.ipua"); ?>"><?= l("logs.ipua");?></a>
            </th>
