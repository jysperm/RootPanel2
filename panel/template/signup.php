...
<section>
  <header><?= $rpL["global.signup"];?> <span class="text-small-per50 not-bold"><?= $rpL["signup.tmp.signingNow"];?><?= $rpCfg["NodeName"];?></span></header>
  <form class="form-horizontal" id="form" method="post">
    ...
    <fieldset>
      <div class="control-group">
        <label class="control-label" for="uname"><?= $rpL["signup.tmp.account"];?></label>
        <div class="controls">
      ...
      <div class="control-group">
        <label class="control-label" for="passwdtext"><?= $rpL["signup.tmp.passwd"];?></label>
        <div class="controls">
          ...
          <button id="isShowPasswd" type="button" class="btn active" data-toggle="button"><?= $rpL["signup.tmp.isRaw"];?></button>
        </div>
      </div>
      <div class="control-group">
